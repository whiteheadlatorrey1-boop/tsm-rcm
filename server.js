...
app.use('/data', express.static(path.join(__dirname, 'data'), { setHeaders: (res) => res.setHeader('Cache-Control', 'no-store') })); // virtual enterprise lab: sample-tickets.json etc.
